...
class FreebitBot:
    ...
    def __init__(self):
        ...
        self.driver = webdriver.Firefox(service=SG(GDM(  # Start the webdriver.
            log_level=0).install()), options=options)
        self.driver.install_addon('C:/Users/mamas/Documents/2captcha-python-master/hcaptcha-solver-python-selenium-master/assets/Tampermonkey.xpi')  # Add extension.
        self.driver.maximize_window()  # Maximize window to reach all elements.        
